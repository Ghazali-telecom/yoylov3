...
from Model.utils.logger import *
from Model.utils.utils import *
from Model.utils.datasets import *
from Model.utils.parse_config import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="custom.data", help="Configuration file to dataset")
    parser.add_argument("--pretrained_weights", type=str, help="Start training from pretrained model")
    ...
    # Get Dataset
    data_config = parse_data_config(opt.dataset)
